	...
	switch (action) {
        ...
        case "detailed-application":
            if (isDefined(contexts[0]) &&
                (contexts[0].name.includes('bluesoft_job_application_details_example_dialog_params_years-of-experience') || contexts[0].name.includes('bluesoft_job_application_details_example_dialog_context'))
